...
public class DataGenerator {
    ...
    public static class Info {
        ...
        public static String getLongOwnerName() {
            return "Pablo Diego Jose Francisco de Paula Juan Nepomuk Maria de los Remedios Cipriano de la Mantissa Trinidad Martyr Patricio Ruiz y Picasso";
        }
